...
\begin{itemize}
  \item \textbf{Customers}(\underline{customer\_id}, customer\_unique\_id,
        ...
        \texttt{Geolocation} (279 customer records, corresponding to 158 distinct ZIP
...
\textbf{Result}: 19,010 records, 0 missing, 0 duplicates.
...
\begin{table}[H]
  ...
  \begin{tabular}{lrrl}
    ...
    rec\_geolocation  &  19,010 &  6 & Aggregated by ZIP \\
...
\begin{itemize}
  ...
  \item \textbf{Geolocation}: aggregating by ZIP loses the point-by-point
        ...
        analyses work at city/state level anyway. It is worth noting that 279
        customer records (158 distinct ZIP codes) and 7 sellers have no match in
...
\begin{table}[H]
  ...
  \begin{tabular}{>{\ttfamily}l
    ...
    payment\_value       & Additive only at order level &
      ...
      the total (20.31M in the DW vs.\ 16.01M in the original payments). Aggregate
...
\sloppy
  ...
  \item \textbf{LEFT JOIN with pre-aggregated payments}: before joining, I aggregate
        ...
        across all of \texttt{fact\_sales} gives 20.31M, vs.\ 16.01M in the original
        per-order payments.
...
\begin{itemize}
  \item \textbf{\texttt{dim\_customer}} and \textbf{\texttt{dim\_seller}} get their
        ...
        matters here: 279 customer records (158 distinct ZIP codes) and 7 sellers
